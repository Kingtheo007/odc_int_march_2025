...
carouselInner.innerHTML = carouselMenuImage("coffee-3759005_1280.jpg", "coffee-3759024_1280.jpg", "coffee-4908764_1920.jpg");
rightMenuImage.innerHTML = rightImage("hot-chocolate-1058197_1280.jpg");
...
function carouselMenuImage(img1, img2, img3) {
    return `<div class="carousel-item border-menu-image active">
            <img src="assets/images/coffee-3759005_1280.jpg" alt="" class="img-fluid menu-image" />
        </div>
        <div class="carousel-item border-menu-image">
            <img src="assets/images/coffee-3759024_1280.jpg" alt="" class="img-fluid menu-image" />
        </div>
        <div class="carousel-item border-menu-image">
            <img src="assets/images/coffee-4908764_1920.jpg" alt="" class="img-fluid menu-image"/>
        </div>
...
function rightImage(image) {
    return `<img src="assets/images/${image}" alt="" class="img-fluid right-menu-image" />`;
}
...
function imgDesserts(e) {
    e.preventDefault();
    carouselInner.innerHTML = carouselMenuImage("chocolate-8709260_1280.jpg", "cake-1971548_1280.jpg", "strawberry-4751821_1280.jpg");
    rightMenuImage.innerHTML = rightImage("cake-906263_1280.jpg");
}

function imgBreakfast(e) {
    e.preventDefault();
    carouselInner.innerHTML = carouselMenuImage("food-5981232_1280.jpg", "ai-generated-8209597_1280.jpg", "cornflakes-4907490_1280.jpg");
    rightMenuImage.innerHTML = rightImage("waffles-7194954_1280.jpg");
}
